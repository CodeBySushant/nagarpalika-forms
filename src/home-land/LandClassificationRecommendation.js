...
// 1
const LandClassificationRecommendation = () => {
  return (
    <div className="land-classification-container">
      ...
      <div className="form-body">
        <p className="body-paragraph">
          उपरोक्त सम्बन्धमा यस <span className="bold-text">नागार्जुन नगरपालिका</span> स्थानीय भू-उपयोग परिषद तथा नगरकार्यपालिकाको <input type="text" className="inline-box-input medium-box" defaultValue="२०७९/१०/२५" /> गतेको निर्णयबाट स्वीकृत भई जारी भएको नागार्जुन नगरपालिका को भू-उपयोग वर्गीकरण मापदण्ड २०७९ <input type="text" className="inline-box-input medium-box" /> मुताविक निवेदकको जग्गा निम्न क्षेत्रमा रहेको व्यहोरा जानकारीको लागि अनुरोध छ ।
        </p>
      </div>
...
export default LandClassificationRecommendation;