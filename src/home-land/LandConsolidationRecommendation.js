...
const LandConsolidationRecommendation = () => {
  return (
    <div className="land-consolidation-container">
      ...
      <div className="form-body">
        <p className="body-paragraph">
          उपरोक्त सम्बन्धमा जिल्ला काठमाडौँ <input type="text" className="inline-box-input medium-box" defaultValue="नागार्जुन नगरपालिका" /> वडा नं. १ बस्ने <input type="text" className="inline-box-input medium-box" required /> <span className="red">*</span> को नाति 
          ...
          <input type="text" className="inline-box-input medium-box" required /> <span className="red">*</span> ले निजको नाममा दर्ता कायम रहेको तपसिल अनुसारका कित्ताहरूलाई एकिकृत गर्नको लागि सिफारिस गराईपाउँ भनि यस कार्यालयमा निवेदन पेश गर्नु भएको हुँदा तहाँ कार्यालयको नियमानुसार उक्त कि नं. को जग्गाहरूलाई एकिकृत गरिदिनुहुन सिफारिस साथ अनुरोध छ ।
        </p>
      </div>
...
export default LandConsolidationRecommendation;