...
import './RequestforCertificationMotherFather.css'; // The CSS file for styling
...
const RequestforCertificationMotherFather = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Request for Certification (Mother/Father) Data:', formData);
    ...
    <div className="request-cert-mf-container">
      <form onSubmit={handleSubmit}>
        ...
        <p className="certificate-body">
          ...
          भई फरक परेता पनि हामीहरु बाबु, आमा र छोरा भएकोले सोही व्यहोरा प्रमाणित गरि पाउन, वडा कार्यालयको सिफारिस, नागरिकता प्रमाणपत्रको फोटोकपी र शैक्षिक योग्यताको प्रमाणपत्रको फोटोकपी सहित रु १०।- को टिकट टाँसी यो निवेदन पेश गरेको छु ।
        </p>
