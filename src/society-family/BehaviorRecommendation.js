    ...
    <div className="behavior-recommendation-container">
      ...
      <div className="form-body">
        <p className="body-paragraph">
          उपरोक्त सम्बन्धमा जिल्ला काठमाडौँ <input type="text" className="inline-box-input medium-box" defaultValue="नागार्जुन नगरपालिका" /> वडा नं. <span className="bg-gray-text">१</span> बस्ने 
          ...
          <input type="text" className="inline-box-input medium-box" required /> <span className="red">*</span> ले यस कार्यालयमा दिएको निवेदन उपर सर्जमिन मुचुल्का तयार गरी बुझ्दा हाल सम्म निजको चालचलन राम्रो रहेको पाइएको हुँदा सोही अनुसारको ब्यहोरा निजको फोटो टाँस गरी प्रमाणित गरिन्छ ।
        </p>
      </div>
