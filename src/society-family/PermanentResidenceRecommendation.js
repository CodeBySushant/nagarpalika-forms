...
const PermanentResidenceRecommendation = () => {
  return (
    <div className="permanent-residence-container">
      {/* --- Top Bar --- */}
      ...
      <div className="subject-section">
        <p>विषय: <span className="underline-text">स्थायी बसोबास सिफारिस।</span></p>
      </div>

      {/* --- Main Body --- */}
      <div className="form-body">
        <p className="body-paragraph">
          उपरोक्त विषयमा निवेदक श्री 
          <select className="inline-select">
              <option>श्री</option>
              <option>सुश्री</option>
              <option>श्रीमती</option>
          </select>
          <input type="text" className="inline-box-input medium-box" required /> <span className="red">*</span> ले पेश गर्नुभएको निवेदनका आधारमा <input type="text" className="inline-box-input medium-box" /> <span className="red">*</span>
          ...
          वडा नं. <input type="text" className="inline-box-input tiny-box" required /> <span className="red">*</span> ) अन्तर्गत तल उल्लेखित स्थानमा विगत मिति <input type="text" className="inline-box-input medium-box" defaultValue="२०८२-०८-०६" /> देखि स्थाई बसोबास गर्दै आउनु भएको व्यहोरा सिफारिस साथ अनुरोध छ ।
        </p>
      </div>

      {/* --- Resident Details (Basobas Garneko) --- */}
