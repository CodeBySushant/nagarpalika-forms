    ...
    <div className="destitute-rec-container">
      ...
      <div className="form-body">
        <p className="body-paragraph">
          उपरोक्त सम्बन्धमा जिल्ला <span className="underline-text">काठमाडौँ</span> , <span className="underline-text">नागार्जुन</span> वडा नं <span className="underline-text">१</span> (साविक जिल्ला <span className="underline-text">काठमाडौँ</span> , 
          ...
          <input type="text" className="inline-box-input medium-box" required /> <span className="red">*</span> को पारिवारी आर्थिक अवस्थाको बारेमा बुझ्दा निजको परिवार विपन्न वर्गमा पर्ने व्यहोरा सिफारिस साथ अनुरोध गरिन्छ।
        </p>
      </div>
